        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card p-8 lg:p-10 rounded-3xl border border-white/10 mb-8 relative overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center gap-6">
              <div className="flex-1 space-y-3">
                <p className="sp-label">{t('opportunitiesPage.hero.eyebrow')}</p>
              ...
              <div className="flex gap-3 flex-wrap w-full lg:w-auto">
                <button onClick={() => navigate('/pricing')} className="sp-btn-primary px-6 py-3 whitespace-nowrap w-full sm:w-auto">
                  {t('opportunitiesPage.actions.viewMembershipOptions')}
                </button>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            <aside className="xl:col-span-1">
              <div className="glass-card p-6 rounded-3xl border border-white/10 xl:sticky xl:top-28">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2 flex-wrap">
                        <h3 className="text-xl font-bold text-[var(--text-primary)] group-hover:text-[var(--sp-accent)] transition-colors break-words leading-snug">
                          {opportunity.title}
                        </h3>
                      ...
                      <p className="text-[var(--text-secondary)] whitespace-pre-line break-words">{opportunity.description}</p>
                    </div>
                    <div className="flex flex-col gap-3 w-full md:w-[200px] lg:w-[220px] shrink-0">
                      <button onClick={() => handleApply(opportunity)} className="sp-btn-primary flex items-center justify-center gap-2 w-full">
                        {t('opportunitiesPage.actions.apply')} <ArrowRight size={16} />
                      </button>
